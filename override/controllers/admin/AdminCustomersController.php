...
class AdminCustomersControllerCore extends AdminController
{
	...
	public function __construct()
	{
		...
		//added (SELECT ad.company FROM '._DB_PREFIX_.'address ad WHERE ad.id_customer = a.id_customer LIMIT 1) as company,
		//NOTE that only first company from first address in database will be shown!
		$this->_select = '
		a.date_add,
		(SELECT ad.company FROM '._DB_PREFIX_.'address ad WHERE ad.id_customer = a.id_customer LIMIT 1) as company,
		...
		//added company array with automatic width
