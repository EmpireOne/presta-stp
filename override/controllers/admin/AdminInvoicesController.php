			...
			'general' => array(
				...
				'fields' =>	array(
					...
					'PS_INVOICE_FREE_TEXT' => array(
						...
						'desc' => $this->l('This text will appear at the bottom of the invoice. Use "~line-break~" for <br />,"~bold-start~" for <b>,"~bold-end~" for </b>. Start second column with "~create-second-column~".'),
						'size' => 6,
						'type' => 'textareaLang',
						'cols' => 40,
						'rows' => 8
