...
<h4><a id="toggle_link" href="#" onclick="toggle_info_block('[-]', '[+]'); return false;"
       title="Expand / Collapse Info block">[-]</a>Info block</h4>
<div class="block_content">
    <img align="right" src="{$modules_dir}onepagecheckout/views/img/info_block_success.png"/>
    ...
    <img align="right" src="{$modules_dir}onepagecheckout/views/img/info_block_phone.png"/>
