...
{l s='Search'}&nbsp;{if $nbProducts > 0}"{if isset($search_query) && $search_query}{$search_query|escape:'htmlall':'UTF-8'}{elseif isset($search_tag) && $search_tag}{$search_tag|escape:'htmlall':'UTF-8'}{elseif isset($category_search_tag) && $category_search_tag}{$category_search_tag|escape:'htmlall':'UTF-8'}{elseif $ref}{$ref|escape:'htmlall':'UTF-8'}{/if}"{/if}
...
{if !$nbProducts}
	<p class="warning">
		...
		{elseif isset($category_search_tag) && $category_search_tag}
			{l s='No results found for your search'}&nbsp;"{$category_search_tag|escape:'htmlall':'UTF-8'}"
		{else}
