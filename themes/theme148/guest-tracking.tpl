...
{else}
	...
	{if isset($show_login_link) && $show_login_link}
		<p><img src="{$img_dir}icon/userinfo.png" alt="{l s='Information'}" class="icon" /><a href="{$link->getPageLink('my-account', true)}">{l s='Click here to login to your customer account.'}</a><br /><br /></p>
	{/if}
